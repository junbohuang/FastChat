...
notice_markdown = ("""
# 🤖 Chat with Vicuna
## An Open-Source Chatbot Impressing GPT-4 with 90% ChatGPT Quality. [[Blog post]](https://vicuna.lmsys.org) [[GitHub]](https://github.com/lm-sys/FastChat) [[Evaluation]](https://vicuna.lmsys.org/eval/)
This is a temporary demo of Vicuna built specifically for the Girls Day 2023 by [Semantic Systems](https://www.inf.uni-hamburg.de/en/inst/ab/sems/home.html) at the University of Hamburg. The demo is based on the [FastChat](https://github.com/lm-sys/FastChat) framework and the [Vicuna](https://vicuna.lmsys.org) model. The demo is hosted on [Gradio](https://gradio.app/).
""")


learn_more_markdown = ("""
### Acknowledgment
Big thanks to **Junbo Huang**, without whom this project would not have been possible!
